...
export function ClientsPage() {
  ...
  // The "View all clients" toggle is authoritative: when it's off, employees are
  // scoped to their assigned clients — SMMs by the Account/Social Media Manager
  // assignment, other employee roles by any team assignment. When it's on, every
  // employee sees every client, matching the Settings > Roles & Permissions toggle.
